...
const pokemon = mongoose.Schema(
  {
    ...
    name: {
      ...
      match: [
        /^([A-ZÆŒ]{1})([A-ZÆŒa-z0-9éàèùâêîôûäëïöüÿçæœ.: -]{0,24})$/,
    ...
    hp: {
      ...
      min: [
        1,
        "Les points de vie du pokémon doivent être un entier compris entre 1 et 255.",
      ],
      max: [
        255,
        "Les points de vie du pokémon doivent être un entier compris entre 1 et 255.",
    ...
    cp: {
      ...
      min: [
        1,
        "Les points d'attaque du pokémon doivent être un entier compris entre 1 et 255.",
      ],
      max: [
        255,
        "Les points d'attaque du pokémon doivent être un entier compris entre 1 et 255.",
    ...
    picture: {
      ...
      match: [
        /^(https:\/\/assets\.pokemon\.com\/assets\/cms2\/img\/pokedex\/detail\/)([0-9]{3,4})(\.png)$/,
    ...
    types: {
      ...
      required: [
        true,
        "Le pokémon doit posséder un au moins un type et au maximum deux types.",
      ],
      enum: {
        values: [
          "Normal",
